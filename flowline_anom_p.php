    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-vt-chart"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-thk-chart"></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function create_year_ddl(data) {
        ...
        var vt_year = data[0].fieldData.flowline_vt_anomaly_year_all.split(",").map(Number);
        ...
        var thk_year = data[0].fieldData.flowline_thk_anomaly_year_all.split(",").map(Number);
    ...
    function gen_chart_anom_vt() {
        Highcharts.chart('flowline-anom-vt-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function show_detail_vt(e) {
        ...
        const param = "flowline,vt_p," + platform + "," + year + "," + risk;
        console.log(param);
        $.ajax({
            type: "GET",
    ...
    function gen_chart_anom_thk() {
        Highcharts.chart('flowline-anom-thk-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function show_detail_thk(e) {
        ...
        const year = e.point.category;
        const risk = e.point.series.name;
        const param = "flowline,thk_p," + platform + "," + year + "," + risk;
        console.log(param);
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/CPOC_AIMS/layouts/executive_summary/script/get_anomaly_line_list_i?script.param=" + param,
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            cellTemplate: function (container, options) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "https://" + url_api + "/fmi/data/v2/databases/CPOC_AIMS/layouts/flowline_info_api/_find",
                                    dataType: 'json',
                                    headers: {
                                        "Authorization": "Bearer " + $.cookie("_token_dashboard"),
                                        "Content-Type": "application/json"
                                    ...
                                    success: function (data) {
                                        //console.log(data);
                                        if(type == 'vt') {
                                            f_path = data.response.data[0].fieldData["flowline_inspection_doc_p_vt::file"];
                                            f_name = data.response.data[0].fieldData.anomaly_vt_permanent_file_related;
                                        } else {
                                            f_path = data.response.data[0].fieldData["flowline_inspection_doc_p_thk::file"];
                            ...
                            cellTemplate: function (container, options) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        //console.log(data);
                                        if(type == 'vt') {
                                            f_path = data.response.data[0].fieldData["flowline_inspection_doc_t_vt::file"];
                                            f_name = data.response.data[0].fieldData.anomaly_vt_temporary_file_related;
                                        } else {
                                            f_path = data.response.data[0].fieldData["flowline_inspection_doc_t_thk::file"];
