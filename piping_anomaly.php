    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-anom-vt-perm-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-anom-thk-perm-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-anom-vt-temp-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-anom-thk-temp-chart"></div>
            </div>
        </div>
    </div>
</div>
<script>
    ...
    function create_year_ddl(data) {
        ...
        var vt_temp_year = data[0].fieldData.piping_vt_anomaly_temporary_year_all.split(",").map(Number);
        ...
        var vt_perm_year = data[0].fieldData.piping_vt_anomaly_permanent_year_all.split(",").map(Number);
        ...
        var thk_temp_year = data[0].fieldData.piping_thk_anomaly_temporary_year_all.split(",").map(Number);
        ...
        var thk_perm_year = data[0].fieldData.piping_thk_anomaly_permanent_year_all.split(",").map(Number);
    ...
    function gen_chart_anom_vt_temp() {
        Highcharts.chart('piping-anom-vt-temp-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_vt_perm() {
        Highcharts.chart('piping-anom-vt-perm-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_thk_temp() {
        Highcharts.chart('piping-anom-thk-temp-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_thk_perm() {
        Highcharts.chart('piping-anom-thk-perm-chart', {
            chart: {
                type: 'column'
            },
            title: {
