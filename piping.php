    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Piping Information</h5>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label class="header-detail">Piping Code</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label class="header-detail">Operating Temp (°C)</label>
                            <input type="text" class="form-control form-control-sm" id="operating_temp_c" readonly>
                        </div>
                        <div class="col-md-2">
                            <label class="header-detail">Operating Temp (°F)</label>
                        ...
                        <div class="col-md-2">
                            <label class="header-detail">CUI Probability</label>
                            <input type="text" class="form-control form-control-sm" id="cui_probability" readonly>
                        </div>
                        <div class="col-md-2">
                            <label class="header-detail">Hot Surface</label>
                            <input type="text" class="form-control form-control-sm" id="hot_surface" readonly>
                        </div>
...
<div class="modal fade" id="library_modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Piping Document</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" style="min-width: 1600px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clearDataInTable()">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body ">
...
<script>
    ...
    var _token_piping = $.cookie("_token_piping");
    var _token_dashboard = $.cookie("_token_dashboard");
    console.log("_token_piping: " + _token_piping);
    ...
    function get_data() {
        ...
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/info_table/records?_limit=10000",
            dataType: 'json',
            headers: {
    ...
    function get_info(id_line) {
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/info_api/script/pipine_api_info?script.param=" + id_line,
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + _token_piping,
                "Content-Type": "application/json"
    ...
    function get_const(id_line) {
        ...
        $.ajax({
            type: "POST",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/design_spec_document/_find",
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + _token_piping,
                "Content-Type": "application/json"
    ...
    function get_insp_report(id_line) {
        ...
        $.ajax({
            type: "POST",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/inspection_document/_find",
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + _token_piping,
                "Content-Type": "application/json"
    ...
    function get_gen_doc(id_line) {
        ...
        $.ajax({
            type: "POST",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/general_document/_find",
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + _token_piping,
                "Content-Type": "application/json"
    ...
    function call_modal_info(data) {
        ...
        $('#stress').tooltip('dispose').tooltip({ title: data[0].stress }).tooltip({ 'trigger': 'hover' })
        ...
        $('#cui_probability').val(data[0].cui_probability);
        $('#cui_probability').tooltip('dispose').tooltip({ title: data[0].cui_probability }).tooltip({ 'trigger': 'hover' })
        $('#hot_surface').val(data[0].hot_surface);
        $('#hot_surface').tooltip('dispose').tooltip({ title: data[0].hot_surface }).tooltip({ 'trigger': 'hover' })
    ...
    function create_modal_rbi_table_COF(data) {
        ...
        for (let i = 0; i <= 3; i++) {
            ...
            titleDiv.className = "rbi-item rbi-span-2 rbi-extra-lightgray";
            titleDiv.textContent = cof_title_list[i];
    ...
    function get_inspection_history(id_line,tag_no) {
        ...
        $.ajax({
            type: "POST",
            url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/report_table/_find",
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + _token_piping,
                "Content-Type": "application/json"
            ...
            success: function (data) {
                ...
                history_list_routine = data.response.data.filter(r => r.fieldData.inspection_type == 'Routine' || r.fieldData.inspection_type == 'VT' || r.fieldData.inspection_type == 'VT+NDE' || r.fieldData.inspection_type == 'CUI');
        ...
        const dataGridRoutine = $("#grid_inspection_history_routine").dxDataGrid({
            ...
            masterDetail: {
                ...
                template(container, options) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "https://" + url_api + "/fmi/data/v2/databases/Piping/layouts/SAP_notify_header_data_export/_find",
                        dataType: 'json',
                        headers: {
                            "Authorization": "Bearer " + _token_piping,
                            "Content-Type": "application/json"
    ...
    function get_file(url,file_name) {
        ...
        body: `url=${url}&token=${_token_piping}&file_name=${file_name}`,
        })
    ...
    function create_table(data) {
        ...
        const dataGrid = $("#dataGid").dxDataGrid({
            ...
            columns: [
                {
                    ...
                    cellTemplate: function (container, options) {
                        ...
                        $('<button type="button" title="Inspection History"></button>').addClass('btn btn-sm fas fa-history')
                            .on('dxclick', function (e) {
                                get_inspection_history(options.value, options.data.fieldData.line_no);
                            }).appendTo(container);
                    },
                    fixed: true,
                    fixedPosition: "left",
                ...
                },
                {
                    ...
                    columns: [{
                        ...
                        dataField: "fieldData.OSI_VT_last_insp_date",
                        calculateCellValue: function (value) {
                            return get_year(value.fieldData.OSI_VT_last_insp_date)
                        }
                    },
                    {
                        ...
                        dataField: "fieldData.OSI_VT_insp_interval",
                        format: {
                            type: "fixedPoint",
                            precision: 2
                        }
                    },
                    {
                        ...
                        dataField: "fieldData.OSI_VT_next_insp_date"
                    },
                    {
                        caption: "Status",
                        // sortOrder: 'asc',
                        ...
                        dataField: "fieldData.OSI_VT_status"
                    }
                    ]
                },
                {
                    ...
                    columns: [{
                        ...
                        dataField: "fieldData.OSI_NDE_last_insp_date",
                        calculateCellValue: function (value) {
                            return get_year(value.fieldData.OSI_NDE_last_insp_date)
                        }
                    },
                    {
                        caption: "Interval (yrs)",
                        ...
                        dataField: "fieldData.OSI_NDE_insp_interval",
                        format: {
                            type: "fixedPoint",
                            precision: 2
                        }
                    },
                    {
                        ...
                        dataField: "fieldData.OSI_NDE_next_insp_date"
                    },
                    {
                        caption: "Status",
                        headerCellTemplate: function (container) {
                        ...
                        dataField: "fieldData.OSI_NDE_status"
                    }
                    ]
                },
                ...
                {
                    caption: "Platform Sort",
                    headerCellTemplate: function (container) {
                        container.append($("<div>Platform<br>Sort</div>"));
                    },
                    dataField: "fieldData.platform_sort",
                    width: "130",
                    alignment: "center",
                    sortOrder: 'desc',
                    visible: false
            ...
            onExporting: function(e) { 
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    workbook.xlsx.writeBuffer().then(function(buffer) {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Piping_Infomation.xlsx');
                    });
                }).then(function() {
            ...
            onCellPrepared: function (e) {
                ...
                if (e.rowType === "data" && e.column.dataField === "fieldData.risk_ranking") {
                    ...
                    // }, function() {
                    //     e.cellElement.css("color", e.data.State == "Illinois" ? "green" : e.data.State == "Minnesota" ? "red" : e.data.State == "Washington" ? "blue" : "black");
                    // })
                }
                ...
                if (e.rowType === "data" && e.column.dataField === "fieldData.OSI_VT_status") {
                    e.cellElement.css("background-color", e.data.fieldData.OSI_VT_status == "Not due" ? "#66FF33" : e.data.fieldData.OSI_VT_status == "On due" ? "#FFCC00" : e.data.fieldData.OSI_VT_status == "Overdue" ? "#FF0000" : "");
                }
                if (e.rowType === "data" && e.column.dataField === "fieldData.OSI_NDE_status") {
                    e.cellElement.css("background-color", e.data.fieldData.OSI_NDE_status == "Not Applicable" ? "#333333" : e.data.fieldData.OSI_NDE_status == "Not due" ? "#66FF33" : e.data.fieldData.OSI_NDE_status == "On due" ? "#FFCC00" : e.data.fieldData.OSI_NDE_status == "Overdue" ? "#FF0000" : "");
                    e.cellElement.css("color", e.data.fieldData.OSI_NDE_status == "Not Applicable" ? "#fff" : "#000");
                }
        ...
        //dataGrid.columnOption('fieldData.platform_codename','filterValues', ['MDPP','ADA']);
