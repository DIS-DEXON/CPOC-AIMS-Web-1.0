<div class="jumbotron jumbotron-header rounded-0 bg-secondary text-white">
    <div class="row">
        <div class="col-12">
            <h1 class="display-4">PIPING INSPECTION PLAN</h1>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-vt-insp-plan-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="piping-nde-insp-plan-chart"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function create_year_ddl(data) {
        ...
        var vt_year = data[0].fieldData.piping_vt_insp_status_year_all.split(",").map(Number);
        ...
        var nde_year = data[0].fieldData.piping_thk_insp_status_year_all.split(",").map(Number);
    ...
    function get_data_vt() {
        ...
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/CPOC_AIMS/layouts/dashboard_piping/script/get_piping_inspection_plan?script.param=" + param,
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + $.cookie("_token_dashboard"),
                "Content-Type": "application/json"
            ...
            success: function (data) {
                ...
                vt_year = val[0].split(",");
                vt_low = val[1].split(",");
                vt_alarp = val[2].split(",");
                vt_high = val[3].split(",");
                vt_very_high = val[4].split(",");
                console.log(vt_year);
                console.log(vt_low);
                console.log(vt_alarp);
                console.log(vt_high);
                gen_chart_vt();
            },
            error: function (error) {
    ...
    function gen_chart_vt() {
        Highcharts.chart('piping-vt-insp-plan-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function show_detail_vt(e) {
        ...
        const param = "piping,vt," + platform + "," + year + "," + risk;
        console.log(param);
        $.ajax({
            type: "GET",
    ...
    function get_data_nde() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                nde_low = val[1].split(",");
                nde_alarp = val[2].split(",");
                nde_high = val[3].split(",");
                nde_very_high = val[4].split(",");
                console.log(nde_year);
                console.log(nde_low);
                console.log(nde_alarp);
    ...
    function gen_chart_nde() {
        Highcharts.chart('piping-nde-insp-plan-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function show_detail_nde(e) {
        ...
        const year = e.point.category;
        const risk = e.point.series.name;
        const param = "piping,nde," + platform + "," + year + "," + risk;
        console.log(param);
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/CPOC_AIMS/layouts/executive_summary/script/get_inspection_line_list_i?script.param=" + param,
