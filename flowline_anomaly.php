<div class="jumbotron jumbotron-header rounded-0 bg-secondary text-white">
    <div class="row">
        <div class="col-12">
            <h1 class="display-4">FLOWLINE ANOMALY</h1>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-vt-perm-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                <h5 class="card-title mb-3">Thickness Anomaly Due (Permanent Repair)</h5>
                <div class="form-inline">
                    PLATFORM
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-thk-perm-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-vt-temp-chart"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
        <div class="card shadow border-0">
            <div class="card-body">
                <h5 class="card-title mb-3">Thickness Anomaly Due (Temporary Repair)</h5>
                <div class="form-inline">
                    PLATFORM
                ...
                <div class="pie-chart-dashboard" id="flowline-anom-thk-temp-chart"></div>
            </div>
        </div>
    </div>
</div>
<script>
    ...
    function create_platform_ddl(data) {
        ...
        $('#platform-ddl-anom-thk-temp').html(options);
        $('#platform-ddl-anom-thk-perm').html(options);
    }
    ...
    function create_year_ddl(data) {
        ...
        var vt_temp_year = data[0].fieldData.flowline_vt_anomaly_temporary_year_all.split(",");
        ...
        var vt_perm_year = data[0].fieldData.flowline_vt_anomaly_permanent_year_all.split(",");
        ...
        var thk_temp_year = data[0].fieldData.flowline_thk_anomaly_temporary_year_all.split(",");
        ...
        var thk_perm_year = data[0].fieldData.flowline_thk_anomaly_permanent_year_all.split(",");
    ...
    function get_data_anom_vt_temp() {
        ...
        $.ajax({
            type: "GET",
            url: "https://" + url_api + "/fmi/data/v2/databases/CPOC_AIMS/layouts/dashboard_flowline/script/get_flowline_anomaly?script.param=" + param,
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + $.cookie("_token_dashboard"),
                "Content-Type": "application/json"
    ...
    function gen_chart_anom_vt_temp() {
        ...
        Highcharts.chart('flowline-anom-vt-temp-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_vt_perm() {
        ...
        Highcharts.chart('flowline-anom-vt-perm-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_thk_temp() {
        ...
        Highcharts.chart('flowline-anom-thk-temp-chart', {
            chart: {
                type: 'column'
            },
            title: {
    ...
    function gen_chart_anom_thk_perm() {
        ...
        Highcharts.chart('flowline-anom-thk-perm-chart', {
            chart: {
                type: 'column'
            },
            title: {
